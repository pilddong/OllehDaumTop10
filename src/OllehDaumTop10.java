...
import functions.DaumTopKeywords;
...
public class OllehDaumTop10 { 
    public static void main(String[] args) throws Exception {
    	...
    	DaumTopKeywords dtk = new DaumTopKeywords();
    	
    	HashSet<String> searchlist = new HashSet<>();
    	
    	searchlist.addAll(dtk.getKeywords());
    	...
    	while(true) {
	        ...
	        Document document = Jsoup.parse(new URL(pageUrl).openStream(),"UTF-8", pageUrl);
	        ...
	        try {
	            ...
	            QueryResult result;
	   	         ...
	   	         //HashMap<String, Integer> AdultList = new HashMap<String, Integer>();
